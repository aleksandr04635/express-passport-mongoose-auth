...
userController.home = function(req, res) {
 //     if (req.session.userid){console.log(req.session.userid);}
  ...
  if (req.user){
    mes1=`Hello, user ${req.user.username}. <br> Your IP is ${req.header('x-forwarded-for') ||req.socket.remoteAddress}. <br> Your session will end in ${(req.session.cookie.maxAge/1000/60).toFixed(0)} 
